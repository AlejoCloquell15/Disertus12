...
class RecuperarPassword extends BaseController
{
    ...
    {
        return view('cambiarPassword/spEnviarCorreo');
    }
    ...
    public function correo()
    {
        ...
        if ($idUsuario == null) {
            ...
            return View('cambiarPassword/spEnviarCorreo', $mensaje);
        } else {
            $dato = [
                'IdUsuario' => $idUsuario,
            ];
            ...
            return view('cambiarPassword/spEnviarCodigo', $idUsuario);
        }
    }
    ...
    public function enviarCodigo()
    {
        ...
        if ($this->request->getVar('botonVerificar')) {
            ...
            if ($res == null) {
                ...
                return view('cambiarPassword/spEnviarCodigo', $mensaje);
            } else {
                $IdUsuario = [
                    'IdUsuario' => $IdUsuario,
                ];
                return view('cambiarPassword/spCambiarPassword', $IdUsuario);
            }
        }
    }
    ...
    public function cambiarPassword()
    {
        ...
        if ($validation == false) {
            ...
            return view('cambiarPassword/spCambiarPassword', $data);
        } else {
