...
<body>
    ...
    <div class="div-principal">
        ...
        <form action="<?php echo base_url(); ?>datosDispositivo" method="post" class="form-principal"
            ...
            <div class="div-form">
                ...
                <input type="number" id="miInput" name="tiempoDucha">
                <br>
                ...
                <input type="number" id="miInput" name="tiempoEspera">
                <br>
                ...
                <input type="number" id="miInput" name="tiempoTolerancia">
                <br><br>
    ...
    function validarFormulario() {
        ...
        if (valorInput <= '0') {
            alert('No se permiten valores de cero o menores');
